                ...
                <tbody class="table-group-divider">
                    @forelse ($comics as $comic)
                        <tr class="table-primary">
                            ...
                            <td>{{ $comic->series }}</td>
                            <td>
                                <a href="{{ route('admin.comics.show', $comic->id) }}"><i class="fa-solid fa-eye">View</i></a>
                                <a href="{{ route('admin.comics.edit', $comic->id) }}"><i class="fa-solid fa-regular fa-pen-to-square"> Edit</i></a>
