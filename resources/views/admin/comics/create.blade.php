    ...
    <div class="row me-5">
        <form action="{{route('admin.comics.store')}}" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text"
                  class="form-control" name="series" id="series" aria-describedby="helpId" placeholder="comic's serie">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="type" id="type" aria-describedby="helpId" placeholder="Insert type">
                <small id="helpId" class="form-text text-muted">Inserisci la tipologia di fumetto</small>
            </div>
            <div class="mb-3">
                <label for="product_code" class="form-label">Data di rilascio</label>
                <input type="date" class="form-control" name="product_code" id="product_code" aria-describedby="helpId" placeholder="">
